...
async def start_command(client: Client, message: Message):
    ...
    if id == owner_id:
        ...
        await message.reply("<b>You are the owner! Additional actions can be added here.</b>")
        ...
        if "verify_" in message.text:
            ...
            if verify_status["link"] == "":
                reply_markup = None
            await message.reply(f"<b>Your token successfully verified and valid for: 24 Hour</b>", reply_markup=reply_markup, protect_content=False, quote=True)
            ...
            SD = await message.reply_text("<b>Baka! Files will be deleted After 10 Min. Save them to the Saved Message now!</b>")
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                btn = [
                    [InlineKeyboardButton("✔ 𝙑𝙀𝙍𝙄𝙁𝙔 ✔", url=link)],
                    [InlineKeyboardButton('✰ 𝙃𝙤𝙬 𝙏𝙤 𝙑𝙀𝙍𝙄𝙁𝙔 ✰' , url=TUT_VID)]
                ]
                await message.reply(f"<b>Your Ads Token is expired, refresh your Token and try again.</b>\n\n<b>⏰Token Timeout: {get_exp_time(VERIFY_EXPIRE)}</b>\n\n<b>This is an ads Token. If you pass 1 Ad, you can use the bot for 24 Hour after passing the Ad.</b>", reply_markup=InlineKeyboardMarkup(btn), protect_content=False, quote=True)
